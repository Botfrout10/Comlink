<nav class="navbar navbar-top navbar-horizontal navbar-expand-xl navbar-dark bg-gradient-primary">
    <div class="container px-4">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-main">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="{{ route('auth.rootindex') }}">
                        <i class="ni ni-circle-08"></i>
                        <span class="nav-link-inner--text">{{ __('Root') }}</span>
                    </a>
                </li>
                <li class="nav-item">
