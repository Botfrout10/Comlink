            ...
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        ...
                        @if (auth()->user()->admin)
                            <hr class="my-4" />
                            <form method="post" action="{{ route('profile.script_appel') }}" autocomplete="">
                                @csrf
                                @method('put')
                                @if (session('script_status'))
                                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                                ...
                                @elseif (session('script_errors'))
                                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                        {{ session('script_errors') }}
                                        <button type="button" class="close" data-dismiss="alert"
                                            aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                ...
                                <h6 class="heading-small text-muted mb-4">{{ __('Script d\'appel') }}</h6>


                                <div class="pl-lg-4">
                                    <div class="form-group {{ $errors->has('script_appel') ? ' has-danger' : '' }}">
                                        <label class="form-control-label"
                                            for="input-name">{{ __('Script d\'appel') }}</label>
                                        <textarea name="script_appel"
                                            class="form-control form-control-alternative{{ $errors->has('script_appel') ? ' is-invalid' : '' }}" id=""
                                            cols="30" rows="10" style="resize: none;">{{ __($sa) }}</textarea>
                                        @if ($errors->has('script_appel'))
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $errors->first('script_appel') }}</strong>
                                            </span>
                                        @endif
                                    </div>
                                    <div class="text-center">
